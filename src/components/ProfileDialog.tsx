...
export function ProfileDialog({ open, onOpenChange }: ProfileDialogProps) {
  ...
  const { dark, setDark, themeId, setThemeId, customAccent, setCustomAccent, customBg, setCustomBg, titleStyle, setTitleStyle } = useTheme();
