                ...
                <CardContent className="pt-6 pb-4">
                  ...
                  <ResponsiveContainer width="100%" height={220}>
                    <BarChart data={monthlyBarData} barSize={24}>
                      ...
                      <XAxis dataKey="month" tick={{ fontSize: 11, fill: "hsl(var(--foreground))" }} stroke="hsl(var(--border))" />
                      <YAxis allowDecimals={false} tick={{ fontSize: 11, fill: "hsl(var(--foreground))" }} stroke="hsl(var(--border))" width={24} />
                      <Tooltip
                        contentStyle={{
                          borderRadius: "10px",
                          fontSize: "13px",
